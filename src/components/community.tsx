...
const Community = ({ daoDetails }: { daoDetails: DaoDetails }) => {
  ...
  return (
    <div className='group flex flex-row items-center gap-4 rounded-full bg-gradient-to-l from-gray-0 to-gray-100 hover:from-purple-0 hover:to-purple-100 md:w-[346px]'>
