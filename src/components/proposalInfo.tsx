...
const ProposalInfo = () => {
  ...
  return (
    <div className='flex-grow bg-true-black-900 px-12 py-6 md:px-24 md:py-12'>
      <div className='flex flex-col gap-12 md:flex-row md:justify-center md:gap-36'>
        <div className='flex w-full flex-col gap-4 md:w-7/12'>
          <p className='text-justify text-xl font-bold leading-6 text-true-white-100'>
            Description
          </p>
          <p className='break-words text-justify text-base font-medium leading-6 text-true-gray-700'>
            {description}
          </p>
        </div>
        <div className='w-full text-true-white-100 md:w-4/12'>
          <Slider />
        </div>
      </div>
    </div>
