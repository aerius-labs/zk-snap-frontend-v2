...
export default function ProposalCard({ proposal }: any) {
  ...
  return (
    <Link href={`/proposal/${id}`}>
      <div className='flex size-[248px] cursor-pointer flex-col gap-2 rounded-[20px] border-2 border-true-gray-700 bg-true-black-700 p-6 font-bold hover:border-true-purple-100 hover:bg-true-purple-100'>
