...
export default function FAQ() {
  ...
  return (
    <div className='mx-4 mb-10 mt-4 flex min-h-[490px] w-[90%] flex-col rounded-2xl border-2 border-dividers bg-lightDark sm:mx-6 md:mx-8 lg:mx-24'>
      <div className='flex flex-col p-20 md:flex-row'>
        ...
        <div className='flex w-full flex-col gap-8 bg-lightDark text-light'>
